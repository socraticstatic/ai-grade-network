...
export const FLOWS = [
  { t: '14:02:11', src: '10.12.4.31', dst: '52.94.76.10', proto: 'TCP 443', bytes: '4.1 MB', path: 'AT&T network', zone: 'vSRX inspected', action: 'allow' },
  { t: '14:02:11', src: '10.12.7.8', dst: '20.42.65.90', proto: 'TCP 443', bytes: '1.8 MB', path: 'AT&T network', zone: 'vSRX inspected', action: 'allow' },
  { t: '14:02:12', src: '10.12.9.104', dst: '104.16.1.1', proto: 'TCP 80', bytes: '12 KB', path: 'Public internet', zone: 'None', action: 'deny' },
  { t: '14:02:12', src: '10.12.4.77', dst: '35.190.2.2', proto: 'UDP 443', bytes: '640 KB', path: 'AT&T network', zone: 'vSRX inspected', action: 'allow' },
  { t: '14:02:13', src: '10.12.11.2', dst: '198.51.100.7', proto: 'TCP 22', bytes: '3 KB', path: 'Public internet', zone: 'None', action: 'deny' },
  { t: '14:02:13', src: '10.12.7.41', dst: '52.94.76.14', proto: 'TCP 443', bytes: '9.7 MB', path: 'AT&T network', zone: 'vSRX inspected', action: 'allow' },
];
